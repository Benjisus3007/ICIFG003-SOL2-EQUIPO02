...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS cliente (
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS categoria_producto (
    id SERIAL PRIMARY KEY,
    nombre_categoria VARCHAR(100),
    descripcion VARCHAR(255)
);"

psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS producto (
    id SERIAL PRIMARY KEY,
    nombre VARCHAR(150),
    descripcion TEXT,
    precio NUMERIC(10,2),
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS mascota (
    id SERIAL PRIMARY KEY,
    nombre VARCHAR(100),
    especie VARCHAR(50),
    raza VARCHAR(100),
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS carrito (
    id SERIAL PRIMARY KEY,
    fecha_creacion TIMESTAMP,
    id_cliente INTEGER REFERENCES cliente(id)
);"

psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS detalle_carrito (
    id SERIAL PRIMARY KEY,
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "CREATE TABLE IF NOT EXISTS contacto (
    id SERIAL PRIMARY KEY,
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO cliente 
(rut, nombre, apellido, correo, telefono, direccion, fecha_registro)
VALUES 
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO categoria_producto 
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO producto 
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO carrito 
(fecha_creacion, id_cliente) 
VALUES (CURRENT_TIMESTAMP, 1), 
(CURRENT_TIMESTAMP, 2);"

echo Insertando mascotas...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO mascota 
(nombre, especie, raza, sexo, fecha_nacimiento, peso, id_cliente) 
VALUES 
...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO detalle_carrito 
(precio_unitario, cantidad, id_carrito, id_producto) 
VALUES 
(18990, 1, 1, 1), 
(12990, 1, 1, 7), 
(9990, 1, 2, 4), 
...
echo Insertando contactos de prueba...
psql -U postgres -h localhost -p 5432 -d petshopdb -c "INSERT INTO contacto 
(nombre, correo, mensaje, fecha_envio) 
VALUES 
